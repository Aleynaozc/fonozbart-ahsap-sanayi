              ...
              {menuItems.map((item) => (
                <div key={item.name} className="relative">
                  <a
                    ...
                    className={`relative inline-block text-sm font-medium tracking-wide transition-all duration-300 hover:scale-105 py-2 ${
            ...
            {menuItems.map((item, index) => (
              <div key={item.name} className="relative">
                <a
                  ...
                  className={`relative block text-sm font-medium tracking-wide transition-all duration-300 py-2 ${
                    activeMenu === item.name ? "text-white" : "text-gray-300 hover:text-white"
                  } ${clickedMenu === item.name ? "animate-pulse" : ""}`}
                  style={{
                ...
                >
                  ...
                  {activeMenu === item.name && (
                    <span className="absolute left-1/2 top-full -translate-x-1/2 mt-2 flex items-end gap-0.5 transition-all duration-300">
                      <span className="w-px h-2 bg-white rounded-sm animate-fade-in" />
                      <span className="w-px h-3 bg-[#D4A574] rounded-sm animate-fade-in delay-75" />
                      <span className="w-px h-2 bg-white rounded-sm animate-fade-in delay-150" />
                    </span>
                  ...
                  {/* Mobile hover preview indicator */}
                  <div className="absolute inset-0 bg-gradient-to-r from-[#D4A574]/10 via-[#D4A574]/20 to-transparent opacity-0 hover:opacity-100 transition-all duration-300 transform -translate-x-full hover:translate-x-0"></div>
                </a>
              </div>
            ))}
          </nav>
