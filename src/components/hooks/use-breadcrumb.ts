...
const pageDescriptions: Record<string, string> = {
  ...
  "/about":
    "FNZ Ahşap Sanayi olarak yarım asrı aşkın tecrübemizle ahşap mobilya sektöründe güvenilir bir marka olmayı başardık.",
  "/services":
  ...
  "/contact": "FNZ Ahşap Sanayi ile iletişime geçin. Ücretsiz keşif ve danışmanlık hizmeti için bize ulaşın.",
}
  ...
  const breadcrumbData = useMemo(() => {
    ...
    if (pathname === "/") {
      return {
        ...
        keywords: ["fnz ahşap sanayi", "ana sayfa", "ahşap mobilya", "mobilya tasarımı","marmaris","mobilya","mutfak"],
      }
    }
    ...
    const description =
      pageDescriptions[pathname] || `${currentPage} - FNZ Ahşap Sanayi hizmetleri ve ürünleri hakkında detaylı bilgi.`
    const keywords = [
      "fnz ahşap sanayi",
