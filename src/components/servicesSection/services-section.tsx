...
export default function ProjectSlider() {
  ...
  return (
    <section className={`relative w-full overflow-hidden bg-[#333333] ${poppins.className} font-normal`}>
      {/* Navigation Arrows */}
      <button
        onClick={prevSlide}
        className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 z-30 bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-full p-2 transition-all duration-300"
      ...
      <button
        onClick={nextSlide}
        className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 z-30 bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-full p-2 transition-all duration-300"
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 p-6 text-white z-20 w-full">
                <div className="absolute bottom-[15px] text-left transition-all duration-300 group-hover:bottom-[30px]">
                  <div className="text-sm font-light text-gray-300 mb-1 uppercase tracking-wider">
                    {project.category}
                  </div>
