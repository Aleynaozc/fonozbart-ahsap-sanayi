                    ...
                    >
                        ...
                        >
                            <motion.span
                                ...
                                className="text-orange-400 font-medium mb-3 text-sm sm:text-lg md:text-xl lg:text-2xl tracking-wide uppercase"
                            >
                    ...
                    {slides.map((_, index) => (
                        <button
                            ...
                            className={`rounded-full transition-all duration-300 hover:scale-110 active:scale-95 ${
                                index === currentSlide
                                    ? 'bg-orange-500 w-6 h-2.5 sm:w-8 sm:h-3 md:w-10 md:h-4'
