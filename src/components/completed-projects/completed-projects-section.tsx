  ...
  return (
    <section ref={sectionRef} className={`relative w-full bg-[#1e1e1f] py-20 lg:py-32 ${poppins.className}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div
          className={`text-center mb-20 lg:mb-28 transition-all duration-800 ${
        ...
        {/* Stats */}
        <div
          className={`grid grid-cols-2 lg:grid-cols-4 gap-8 mb-20 lg:mb-28 transition-all duration-800 delay-200 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
          {[
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          {projects.map((project, index) => (
            ...
            >
              <div
                className={`relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden transition-all duration-500 hover:bg-white/8 hover:border-white/20 ${
        ...
        {/* Bottom CTA */}
        <div
          className={`text-center mt-20 lg:mt-28 transition-all duration-800 delay-1000 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
